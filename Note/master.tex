...
\item \begin{definition}[KKT Conditions for a General NLP II]\label{kkt2}
...
\item \begin{definition}[KKT Conditions for an NLP without Equality Constraints]\label{kkt3}
...
\item \begin{definition}[KKT Conditions for an NLP without Equality Constraints II]\label{kkt4}
